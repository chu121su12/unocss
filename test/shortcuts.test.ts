...
describe('shortcuts', () => {
  const uno = createGenerator({
    shortcuts: [
      ...
      ['shortcut-hover-active-1', 'bg-green-300 focus:bg-green-300 hover:bg-green-300 active:bg-green-300 disabled:bg-green-300'],
      ['shortcut-hover-active-2', 'bg-white focus:bg-red-300 hover:bg-yellow-300 active:bg-blue-300 disabled:bg-gray-300'],
